  ...
  return (
    <div className="min-h-screen bg-gray-700 text-white flex flex-col justify-between">
      ...
      <header className="w-full px-6 py-4 border-b border-neutral-800 flex justify-between items-center">
        <h1 className="lg: text-4xl sm: text-xl font-bold tracking-wide">SPINE</h1>
        <nav>
          <div className='absolute left-1/2 transform -translate-x-1/2'>
          <a href="/" className="flex-1 flex lg: text-3xl sm: text-sm justify-center hover:underline font-bold">Back to Landing</a>
          </div>
